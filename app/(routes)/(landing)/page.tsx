...
const LandingPage = () => {
  ...
  return (
    <>
      <div style={{ backgroundImage: "url('https://kit.sociolib.com/nextchat/wp-content/uploads/sites/11/2024/09/Line-grid.png')" }} className='text-secondary pt-[3rem] -mt-[3rem] bg-cover bg-blend-screen bg-center w-dvw bg-[#12413a]'>
