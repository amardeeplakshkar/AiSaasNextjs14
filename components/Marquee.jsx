...
const ReviewCard = ({ img, name, username, body }) => {
  return (
    <figure
      className={cn(
        'relative h-[8rem] w-[14rem] cursor-pointer overflow-hidden rounded-xl border p-4',
...
export default function MarqueeDemoVertical() {
  return (
    <div className="relative flex h-[500px] w-full flex-row items-center justify-center overflow-hidden rounded-lg md:shadow-xl">
